...
function remove-cursor-shortcut {
    Remove-Item 'c:/Users/asddf/AppData/Local/Programs/cursor/resources/app/bin/code' -ErrorAction SilentlyContinue
    Remove-Item 'c:/Users/asddf/AppData/Local/Programs/cursor/resources/app/bin/code.cmd' -ErrorAction SilentlyContinue
}